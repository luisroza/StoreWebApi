...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StoreApi.Sales.Domain.Coupon", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("StoreApi.Sales.Domain.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("StoreApi.Sales.Domain.OrderLine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("StoreApi.Sales.Domain.Order", b =>
                {
                    b.HasOne("StoreApi.Sales.Domain.Coupon", "Coupon")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("StoreApi.Sales.Domain.OrderLine", b =>
                {
                    b.HasOne("StoreApi.Sales.Domain.Order", "Order")
                        .WithMany("OrderLines")
