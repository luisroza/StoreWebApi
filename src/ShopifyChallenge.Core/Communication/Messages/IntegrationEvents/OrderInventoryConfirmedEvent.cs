...
namespace Store.Core.Communication.Messages.IntegrationEvents
{
    public class OrderInventoryConfirmedEvent : IntegrationEvent
    {
        ...
        public OrderInventoryConfirmedEvent(Guid customerId, Guid orderId, OrderItemList itemList, decimal total, string cardName, string cardNumber, string cardExpirationDate, string cardVerificationCode)
        {
            AggregateId = orderId;
